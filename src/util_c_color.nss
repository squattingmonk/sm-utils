...
//          Ed Burke (tinygiant98) <af.hog.pilot@gmail.com>
// -----------------------------------------------------------------------------
// This file holds color codes for use with the functions from util_i_color.nss.
// These are hex color codes, the same as you'd use in web design and may other
...
// use in your module.
// ----- Acknowledgements ------------------------------------------------------
// Color codes generated by tinygiant98. Default function colors copied from
// https://nwn.wiki/display/NWN1/Colour+Tokens.
// -----------------------------------------------------------------------------
